...
export default function Home() {
  return (
    ...
    <Image 
    src={ImageProfile}
    className="border-4  w-full rounded-full border-appGreen-500"
    />
    </div>
    </div>
    ...
    <div className="flex flex-row flex-wrap justify-evenly">
      <div className="border rounded mt-5 p-4 mx-2 lg:mx-0 lg:w-96 bg-white shadow-sm lg:shadow-2xl">
    ...
    <div className=" mt-20 lg:mt-64 text-appGreen-900 font-inter w-10/12 mx-auto mb-20 lg:mb-64">
      <h1 className="text-center font-bold text:2xl lg:text-4xl underline">MY PROJECT</h1>

<div className="flex flex-col lg:flex-row flex-wrap justify-evenly">
      <div className="border rounded mt-24 p-4 lg:w-2/5 bg-white shadow-sm  lg:shadow-2xl">
        <Image 
    src={ImageBs}
