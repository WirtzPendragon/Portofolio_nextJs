...
export default function Home() {
  return (
    <>
    <div className="mt-32 mx-auto flex flex-col-reverse justify-center items-center lg:flex-row lg:justify-evenly lg:w-10/12 font-inter">
    ...
    <div className="mt-40 lg:mt-64 text-appGreen-900 font-inter lg:w-10/12 mx-auto mb-40" data-aos="fade-down">
      <h1 className="text-center font-bold text-2xl lg:text-4xl" id="section-about">ABOUT ME</h1>
    <div>
    ...
    <div className="flex flex-row flex-wrap justify-evenly">
      <div className="border rounded mt-5 p-4 mx-2 lg:mx-0 lg:w-96 bg-white shadow-sm lg:shadow-2xl" data-aos="fade-right"
   >
        <h2 className="font-semibold text-lg">Study</h2>
        <p className="text-xs lg:text-base">I am a student at SMK Wira Harapan, and I have chosen the RPL program because of my passion for technology and software development. This field allows me to explore my creativity and problem-solving skills by learning to design and develop innovative software solutions.</p>
      </div>
...
>
        ...
        <p className="text-xs lg:text-base">Staying fit is really important to me as a student because it helps me stay energized and focused on my studies. I make time for regular exercise, like jogging, doing workouts, or even yoga, to keep my body active and my mind clear. </p>
      </div>
      <div className="border rounded mt-5 p-4 mx-2 lg:mx-0 lg:w-96 bg-white shadow-sm lg:shadow-2xl" data-aos="fade-left"
>
        <h2 className="font-semibold text-lg">Playing games</h2>
        <p className="text-xs lg:text-base">As a student, I enjoy playing games in my free time. It’s a great way for me to relax, have fun, and sometimes even challenge my problem-solving and strategic thinking skills. Gaming helps me stay balanced, giving me a break from studies while keeping my mind sharp and entertained.</p>
      </div>
    </div>
    </div>
    ...
    <div className=" mt-20 lg:mt-40 text-appGreen-900 font-inter w-10/12 mx-auto mb-20 lg:mb-64">
      <h1 className="text-center font-bold text:3xl lg:text-4xl underline" data-aos="fade-down" id="project">MY PROJECT</h1>
...
<div className="flex flex-col lg:flex-row flex-wrap justify-evenly">
    ...
    <div className="mt-40 lg:mt-64 text-appGreen-900 font-inter lg:w-10/12 mx-auto mb-40" data-aos="fade-down" >
    <h1 className="text-center font-bold text-2xl lg:text-4xl" id="section-contact">MY CONTACT</h1>
    </div>
    </>
  );
}
